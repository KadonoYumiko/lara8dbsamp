...
<section>
    <div class="bg-white hover:bg-white p-5 mb-10 rounded-md shadow-md">
        ...
        <p class="text-gray-400 text-sm text-right px-3"><time datetime="{{ $article->created_at }}">{{ $article->created_at }}</time></p>
    ...
    <div class="flex justify-end">
        ...
        <a href="{{ route( "kadai06_1.edit", $article->id ) }}" class="block w-20 text-white text-center bg-pink-600 hover:bg-pink-500 px-3 py-2 rounded-md">編集</a>
    </div>
</section>
@endsection
